(()=>{function h(){document.addEventListener("DOMContentLoaded",()=>{let a=()=>{let t=window.innerWidth,s={640:"SM",768:"MD",1024:"LG",1280:"XL",1536:"2XL"},o=Object.keys(s).filter(x=>x<t).at(-1);return s[o]||"Default"},i=document.createElement("script");i.setAttribute("src","https://cdn.tailwindcss.com?plugins=forms,typography,aspect-ratio,line-clamp"),document.head.appendChild(i);let n=document.createElement("div"),l=(t,s)=>`
      <div>
    ...
    `,n.classList.add("fixed");let c=["right-4","bottom-4"];c.forEach(t=>n.classList.add(t)),document.body.appendChild(n);let w=document.getElementById("twaBreakpoint"),g=document.getElementById("twaClasses"),f=[...document.querySelectorAll('input[type="checkbox"]')],v=document.getElementById("twaClassesAdd"),p=document.getElementById("twaClassesEditor"),b=[...document.querySelectorAll("[data-position]")],E=[...document.querySelectorAll("[data-relative]")],e,m;document.addEventListener("click",t=>{twaPopup.contains(t.target)||(twaPopup.open=!1),t.metaKey&&(twaPopup.open=!0,e=t.target,w.innerText=a(),g.innerText=e.className,f.forEach(s=>s.checked=!0),p.value=e.className,m=u(e))}),f.forEach(t=>{t.addEventListener("input",()=>{m[t.name].forEach(s=>e.classList.toggle(s)),g.innerText=e.className,p.value=e.className})}),E.forEach(t=>{t.addEventListener("click",()=>{let s,o=t.getAttribute("data-relative");o==="parent"&&(s=e.parentElement?e.parentElement:e,!e.parentElement&&console.warn("No parent element")),o==="prev"&&(s=e.previousElementSibling?e.previousElementSibling:e,!e.previousElementSibling&&console.warn("No previous sibling element")),o==="next"&&(s=e.nextElementSibling?e.nextElementSibling:e,!e.nextElementSibling&&console.warn("No next sibling element")),o==="child"&&(s=e.firstElementChild?e.firstElementChild:e,!e.firstElementChild&&console.warn("No child element")),e=s,g.innerText=e.className,f.forEach(x=>x.checked=!0),p.value=e.className,m=u(e)})}),v.addEventListener("submit",t=>{t.preventDefault(),e.className=p.value,m=u(e)}),window.addEventListener("resize",()=>{w.innerText=a()}),b.forEach(t=>{t.addEventListener("click",()=>{c.forEach(s=>n.classList.remove(s)),c=t.getAttribute("data-position").split(","),c.forEach(s=>n.classList.add(s))})})});let u=a=>({"2xl":[...a.classList].filter(i=>i.startsWith("2xl:")),xl:[...a.classList].filter(i=>i.startsWith("xl:")),lg:[...a.classList].filter(i=>i.startsWith("lg:")),md:[...a.classList].filter(i=>i.startsWith("md:")),sm:[...a.classList].filter(i=>i.startsWith("sm:")),dark:[...a.classList].filter(i=>i.startsWith("dark:"))})}h();})();
