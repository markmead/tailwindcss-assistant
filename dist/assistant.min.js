(()=>{function E(){let x=()=>{let e=window.innerWidth,t={640:"sm",768:"md",1024:"lg",1280:"xl",1536:"2xl"},a=Object.keys(t).filter(h=>h<e).at(-1);return t[a]||"Default"},v=document.createElement("script");v.setAttribute("src","https://cdn.tailwindcss.com?plugins=forms,typography,aspect-ratio,line-clamp"),document.head.appendChild(v);let i=document.createElement("div"),n=(e,t)=>`
      <div>
    ...
    `,i.classList.add("fixed");let c=["right-4","bottom-4"];c.forEach(e=>i.classList.add(e)),document.body.appendChild(i);let w=document.getElementById("twaBreakpoint"),m=[...document.querySelectorAll('input[type="checkbox"]')],k=document.getElementById("twaClassesAdd"),l=document.getElementById("twaClassesEditor"),C=[...document.querySelectorAll("[data-position]")],$=[...document.querySelectorAll("[data-relative]")],f=document.getElementById("twaError"),s,p;document.addEventListener("click",e=>{twaPopup.contains(e.target)||(twaPopup.open=!1),e.metaKey&&(e.preventDefault(),twaPopup.open=!0,s=e.target,w.innerText=x(),m.forEach(t=>t.checked=!0),l.value=s.className,p=g(s))}),m.forEach(e=>{e.addEventListener("input",()=>{p[e.name].forEach(t=>s.classList.toggle(t)),l.value=s.className})}),$.forEach(e=>{e.addEventListener("click",()=>{let t,a=e.getAttribute("data-relative");a==="parent"&&(t=s.parentElement?s.parentElement:s,!s.parentElement&&u("No parent element")),a==="prev"&&(t=s.previousElementSibling?s.previousElementSibling:s,!s.previousElementSibling&&u("No previous sibling element")),a==="next"&&(t=s.nextElementSibling?s.nextElementSibling:s,!s.nextElementSibling&&u("No next sibling element")),a==="child"&&(t=s.firstElementChild?s.firstElementChild:s,!s.firstElementChild&&u("No child element")),s=t,m.forEach(h=>h.checked=!0),l.value=s.className,p=g(s)})}),l.addEventListener("keydown",e=>{e.key==="Enter"&&(e.preventDefault(),b(e))}),k.addEventListener("submit",e=>{b(e)});function b(e){e.preventDefault(),s.className=l.value,p=g(s)}window.addEventListener("resize",()=>{w.innerText=x()}),C.forEach(e=>{e.addEventListener("click",()=>{c.forEach(t=>i.classList.remove(t)),c=e.getAttribute("data-position").split(","),c.forEach(t=>i.classList.add(t))})});let u=e=>{f.removeAttribute("hidden"),f.innerText=e,setTimeout(()=>{f.setAttribute("hidden",!0)},3e3)},g=e=>({"2xl":[...e.classList].filter(t=>t.startsWith("2xl:")),xl:[...e.classList].filter(t=>t.startsWith("xl:")),lg:[...e.classList].filter(t=>t.startsWith("lg:")),md:[...e.classList].filter(t=>t.startsWith("md:")),sm:[...e.classList].filter(t=>t.startsWith("sm:")),dark:[...e.classList].filter(t=>t.startsWith("dark:"))})}document.addEventListener("DOMContentLoaded",()=>{E()});})();
